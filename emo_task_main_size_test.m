...
[basedir, dat_dir, stim_dir, ts_dir] = set_directory('hb_mac'); % 'hb_mac'
...
emo_cat = {'big_size', 'middle_size', 'small_size'};
...
%% TASK START
waitsec_fromstarttime(data.s_key_receive_time, 2); % baseline (blank)
...
for block = 1:2% n_block % block: per emotion category
