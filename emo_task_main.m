...
for block = 1:2 % numel(ts.emo_order{1,run_num}) % block: per emotion category
    ...
    if emotion_num < 14 % video
        ...
        temp_stim_order = ts.stim_order{1,run_num}.music(emotion_num,:);
    end
...
% moviefile =  '/Users/hongji/Dropbox/Cocoan_lab/Collab/7T_HCP_emotion/stimuli_candidates/movie/candidates_video/v02_joy/0597.mp4';
playmode = 1;
